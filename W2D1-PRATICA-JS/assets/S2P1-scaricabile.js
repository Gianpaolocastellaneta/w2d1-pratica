...
if (num1 > num2) {
  alert ("il numero grande è " + num1 )
    console.log("Il numero più grande è: " + num1);
}else if (num2 > num1) {
  alert ("il numero grande è " + num2)
...
/*if (numero1 == 8 || numero2 == 8) {
    console.log("Almeno uno dei numeri è 8");
} 
...
const hasFreeShipping = totalShoppingCart > 50
const shippingPrice = 10


let totalPrice = !hasFreeShipping ? (totalShoppingCart + shippingPrice) : totalShoppingCart
...
/* SCRIVI QUI LA TUA RISPOSTA */
/*const discount = 20
const totalShoppingCart = (40 * discount) / 100;
const hasFreeShipping = totalShoppingCart > 50
const shippingPrice = 10
